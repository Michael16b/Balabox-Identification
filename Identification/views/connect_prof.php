    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card my-5">
                    <form action="/connect_Prof" method="post" class="card-body p-lg-5">
                        <div class="text-center mb-5">
                            <img src="../static/img/logo_balabox.png" class="img-fluid" width="200px" alt="profile">
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control" name="idprof" placeholder="Identifiant" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div id="changeid" class="form-text text-center text-primary">
                            <a href="/" class="fw-bold">Je suis élève</a>
                        </div>
                    </form>
                </div>
             </div>
